...
```javascript
import cwxsa from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-cwxsa@deno/mod.js';
```
...
[@stdlib/blas/ext/base/cxsa]: https://github.com/stdlib-js/blas-ext-base-cxsa/tree/deno
